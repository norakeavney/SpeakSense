...
def _process_job(job_id, file_ref):
    ...
    try:
        ...
        analysis_result = analyse_audio(file_ref, include_diarization=True)
        ...
        # Get audio duration
        try:
            audio, sr = librosa.load(file_ref, sr=None)
        ...
        try:
            ...
            audio_emotions = analyse_audio_emotions(file_ref, transcript_segments)
